...
abstract class ColorPalettes{
  ...
  static const Color colorPrimary = Color(0xFF4860CF);
  ...
  static const colorIndicator = Color(0xFFD2D2D2);
  ...
  static const Color defaultTitleTextColor = Color(0xFF2E2E2E);
  static const Color defaultDarkTitleTextColor =
  Color.fromARGB(255, 217, 213, 213);



  // Button
  static const buttonPrimaryColor = Color(0xFF004E87);
  static const buttonSecondaryColor = Color(0xFFFFFFFF);

  static const deafultBorderColor = Color(0xFFD2D2D2);
  static const focusBorderColor = colorPrimary;
  static const errorBorderColor = Color(0xFFFF6767);
